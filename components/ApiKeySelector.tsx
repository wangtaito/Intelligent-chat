    ...
    <>
      ...
      {showModal && (
        <div className="flex fixed inset-0 z-50 justify-center items-center bg-black bg-opacity-50">
          <div className="p-6 w-96 bg-white rounded-lg dark:bg-gray-800">
            ...
            <button
              ...
              className="p-2 mt-4 w-full text-gray-900 bg-gray-100 rounded-lg transition-colors dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 dark:text-white"
            >
              关闭
            </button>
          </div>
